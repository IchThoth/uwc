...
type SearchResult struct {
	// Total indicates the total number of images 
	//that can be gotten from the SearchResult struct
	Total	int32	`json:"total"`
	//Page is the pages that will be gotten from the api
	Page	int32	`json:"total_page"`
...
func main() {
	...
	var c  = NewClient(AccessToken, SecretKey)
